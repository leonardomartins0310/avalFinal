 ...
 * @author Asus
 */
@WebServlet(name = "FormularioClienteServlet", urlPatterns = {"/FormularioClienteServlet"})
public class FormularioClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int tipoProdutoId = Integer.parseInt(request.getParameter("preferenciaCliente"));
            Tipoproduto tipo= daoTipoProduto.obter(tipoProdutoId);
            Cliente cliente= new Cliente();
            cliente.setNomeCliente(nome);
            cliente.setEmailCliente(email);
            cliente.setTipoProduto(tipo);
